About inline-html-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/inline-html-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/zopyx/inline-html
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4852&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/inline-html-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `inline-html` can be installed with `conda`:
...
```
mamba install inline-html
```

It is possible to list all of the versions of `inline-html` available on your platform with `conda`:
...
```
mamba search inline-html --channel conda-forge
```
...
mamba repoquery search inline-html --channel conda-forge

# List packages depending on `inline-html`:
mamba repoquery whoneeds inline-html --channel conda-forge

# List dependencies of `inline-html`:
mamba repoquery depends inline-html --channel conda-forge
```
